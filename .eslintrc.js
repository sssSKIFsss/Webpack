...
module.exports = {
  ...
  "rules": {
    ...
    // 0: deep destructuring is not compatible https://github.com/eslint/eslint/issues/1863
    "block-scoped-var": 0,
    ...
    // in the outer scope (off by default in the node environment)
    "no-catch-shadow": 2,
    ...
    //"keyword-spacing": [1, {"before": false, "afret": false}],
    ...
    // (words on by default, nonwords off by default)
